...
public class JsToJava implements IGeneratorPlugin {
    ...
    public String convertMethod(Class cls, Expression obj, Method method, Expression[] args, IType returnType) {
        ...
        if (Objects.equals(cls.getName(), "TsArray")) {
            ...
            if (Objects.equals(method.getName(), "split") && args[0] instanceof RegexLiteral) {
            ...
            else if (Objects.equals(method.getName(), "hasKey") || Objects.equals(method.getName(), "has"))
                return objR + ".containsKey(" + argsR[0] + ")";
            else if (Objects.equals(method.getName(), "delete"))
            ...
            if (Objects.equals(method.getName(), "from"))
                return argsR[0];
        }
        ...
        if (!this.unhandledMethods.contains(methodName)) {
            console.error("[JsToJava] Method was not handled: " + cls.getName() + "." + method.getName());
